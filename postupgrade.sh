...
cp -p -v -r /tmp/$TEMPPDIR\_upgrade/config/$PDIR/* $LBHOMEDIR/config/plugins/$PDIR/ 

echo "<INFO> Copy back existing log files"
cp -p -v -r /tmp/$TEMPPDIR\_upgrade/log/$PDIR/* $LBHOMEDIR/log/plugins/$PDIR/ 

echo "<INFO> Remove temporary folders"
rm -r /tmp/$TEMPPDIR\_upgrade
